...
namespace Diagrams.WPF
{
    public class DiagramLogic : IDiagramLogic
    {
        ...
        protected virtual void Family_CollectionChanged(object? sender, System.Collections.Specialized.NotifyCollectionChangedEventArgs e)
        {
            Update?.Invoke(this, new ContentChangedEventArgs(Family.Current));
        }
        ...
        /// </summary>
        public EventHandler<ContentChangedEventArgs> Update { get; set; }
